...
\draw [ultra thick, draw=white, fill=mycol, fill opacity=0.2] ($(current page.north west)+(1.5cm,-1cm)$) rectangle  ($(current page.south east)+(0cm,1.5cm)$) ;
\end{tikzpicture}
\begin{tikzpicture}[remember picture,overlay]
\draw [ultra thick, draw=mycol, fill=white, fill opacity=0.2] ($(current page.north west)+(6.2cm,-3cm)$) rectangle  ($(current page.south east)+(0cm,4cm)$) ;
\end{tikzpicture}
\raggedright
\hspace{0.1\textwidth}
...
\begin{tikzpicture}[remember picture,overlay]
\draw [ultra thin, draw=gray, fill=mycol, fill opacity=0.2	] ($(current page.north west)+(2cm,-2cm)$) rectangle  ($(current page.south east)+(-2cm,3cm)$) ;
\end{tikzpicture}
